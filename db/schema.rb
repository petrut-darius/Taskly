...
ActiveRecord::Schema[8.0].define(version: 2025_08_04_193841) do
  create_table "daily_tasks", force: :cascade do |t|
    t.string "name", default: "Task nou", null: false
  ...
  create_table "projects", force: :cascade do |t|
    t.string "name", default: "Add a project name...", null: false
